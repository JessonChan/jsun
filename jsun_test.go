...
// Ref has json.Marshaler and Unmarshaler methods with pointer receiver.
type Ref int
...
// Val has json.Marshaler methods with value receiver.
type Val int
...
// RefText has json.Marshaler and Unmarshaler methods with pointer receiver.
type RefText int
...
// ValText has json.Marshaler methods with value receiver.
type ValText int
...
func TestRefValMarshal(t *testing.T) {
	...
	var want = strings.ToLower(`{"R0":"ref","R1":"ref","R2":"\"ref\"","R3":"\"ref\"","V0":"val","V1":"val","V2":"\"val\"","V3":"\"val\""}`)
	b, err := Marshal(&s)
	if err != nil {
...
// C implements json.Marshaler and returns unescaped JSON.
type C int
...
// CText implements json.Marshaler and returns unescaped text.
type CText int
...
func TestMarshaljsonRawMessageValue(t *testing.T) {
	type (
		T1 struct {
	...
	tests := []struct {
		...
		// Test with empty, but non-nil, json.RawMessage.
		{rawEmpty, "", false},
		{&rawEmpty, "", false},
		...
		// Test with json.RawMessage with some text.
		//
